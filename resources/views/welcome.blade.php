...
<body>
    ...
    <div class="bg-base-100">
            ...
            <nav class="navbar mx-auto max-w-7xl rounded-b-xl px-4 sm:px-6 lg:px-8">
                <div class="w-full lg:flex lg:items-center lg:gap-2">
                    ...
                    <div id="navbar-block-4"
                        ...
                        <div
                            class="text-base-content flex gap-6 text-base max-lg:mt-4 max-lg:flex-col lg:items-center">
        ...
        <main>
            ...
            <section id="home">
                <div
                    class="gap-18 md:pt-45 lg:gap-35 lg:pt-47.5 flex h-full flex-col justify-between bg-[url('../../img/free-layer-blur.png')] bg-cover bg-center bg-no-repeat py-8 pt-40 sm:py-16 md:gap-24 lg:py-24">
                    <div
                        ...
                        <h1
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="348" height="10"
                                viewBox="0 0 348 10" fill="none"
                                ...
                                <path
                                    ...
                                    stroke="url(#paint0_linear_17052_181397)" stroke-width="2"
                                    stroke-linecap="round" />
                                <defs>
                                    <linearGradient id="paint0_linear_17052_181397" x1="29.7873" y1="1.85626"
                                        x2="45.2975" y2="69.7387" gradientUnits="userSpaceOnUse">
                ...
                <div class="bg-base-200 py-8 sm:py-16 lg:py-24">
                    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        <div class="flex flex-col gap-12 md:gap-16 lg:gap-24">
                            ...
                            <div
                                class="lg:h-161 relative mb-8 h-full w-full rounded-xl max-lg:space-y-6 sm:mb-16 lg:mb-24">
                ...
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="from-primary/30 to-error/30 p-px overflow-hidden rounded-3xl bg-linear-to-r">
                        <div class="bg-base-100 rounded-3xl p-0.5">
                            <div
                                class="from-primary/6 to-error/6 relative rounded-3xl bg-linear-to-r to-50% p-8 lg:p-16">
                                <div
                ...
                <div class="bg-base-100 py-8 sm:py-16 lg:py-24">
                    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
                            ...
                            <div class="card card-border hover:border-primary h-max shadow-none">
                                <figure class="bg-base-200 pt-10.5">
                                    <img src="../assets/img/chef-3.png" alt="Marilyn Westervelt"
                                        class="h-60 w-auto" />
                                </figure>
                                <div class="card-body gap-3 p-5">
                                    ...
                                    <form class="space-y-6" onsubmit="return false;">
                                        <div class="flex gap-6 max-md:flex-col">
                                            ...
                                            <div class="w-full">
                                                ...
                                                <div class="input input-lg">
                                                    <input type="text" class="grow"
                                                        placeholder="+1 (212) 555-1234" id="userphone" />
                                                    <span
                                        ...
                                        <div class="flex gap-6 max-md:flex-col">
                                            <div class="w-full">
                                                ...
                                                <div class="input input-lg">
                                                    <input type="text" class="flatpickr-date grow"
                                                        placeholder="06/11/25" id="userdate" />
                                                    <span
                ...
                <div class="bg-base-100 relative h-full py-8 sm:py-16 lg:py-24">
                    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        ...
                        <span
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="166" height="181"
                                viewBox="0 0 166 181" fill="none">
                                <g opacity="0.06">
                                    <path
                        ...
                        <div class="mb-12 space-y-4 text-wrap text-center sm:mb-16 lg:mb-24">
                            <h2 class="text-base-content text-2xl font-semibold md:text-3xl lg:text-4xl">Frequently
                                Asked Questions</h2>
                        ...
                        <div id="faq-carousel-1"
                            ...
                            <div class="flex gap-1">
                                <!-- Previous Slide -->
                                <button
                                    class="btn btn-circle carousel-prev btn-outline btn-primary hover:bg-primary relative hover:text-white max-md:hidden"
                                    disabled="disabled">
                                ...
                                <div class="carousel rounded-box">
                                    <div class="carousel-body h-full gap-12 opacity-0">
                                        ...
                                        <div class="carousel-slide m-2">
                                            <div
                                                class="rounded-box hover:bg-base-100 hover:ring-primary p-4 text-center hover:ring">
                                                ...
                                                <div class="group mt-5 flex items-center justify-center gap-2">
                                                    <a href="#"
                                                        class="link link-animated link-primary font-normal">Learn
                                                        more</a>
                                                    <span
                                                        class="icon-[tabler--arrow-narrow-right] text-primary size-5 shrink-0 transition-transform group-hover:-translate-x-1 rtl:rotate-180"></span>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- Slide 2 -->
                                ...
                                <!-- Next Slide -->
                                <button
                                    class="btn btn-circle carousel-next btn-primary btn-outline hover:bg-primary relative hover:text-white max-md:hidden">
                        ...
                        <span
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="118" height="119"
                                viewBox="0 0 118 119" fill="none">
                                <g opacity="0.05">
                                    <path
                        ...
                        <span
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="116" height="150"
                                viewBox="0 0 116 150" fill="none">
                                <g opacity="0.08">
                                    <path
